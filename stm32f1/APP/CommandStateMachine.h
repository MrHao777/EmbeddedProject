...
#define state_JudgeUserPwd          'b'   //请求判断用户密码(验证开锁密码)  
...
#define state_SetVerifMode          'h'   //设置验证模式bit0(0:正常模式(允许) 1:安全模式(不允许)) 
#define state_SetWarnMode           'i'   //设置警戒模式bit1(0:未开启 1:开启) 
#define state_JPDO                  'j'   //安全模式下验证密码,开箱 
#define state_JPJUO                 'k'   //安全模式下验证静脉,不开箱 
