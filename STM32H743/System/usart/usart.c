...
{	
  ...
  UART1_Handler.Init.FIFOMode = UART_FIFOMODE_DISABLE;
  UART1_Handler.Init.TXFIFOThreshold = UART_TXFIFO_THRESHOLD_1_8;
  UART1_Handler.Init.RXFIFOThreshold = UART_RXFIFO_THRESHOLD_1_8;
